...
// Физика
let velocityX = -6;// Скорость движения труб по оси X (отрицательное значение для движения влево)
let velocityY = -10 ;// Вертикальная скорость птицы (отрицательное значение для подъёма)
